...
**Terax**: open-source terminal-first development workspace. Tauri 2 + Rust (`portable-pty`) backend, React 19 + TypeScript + xterm.js (WebGL) client, with coding-agent CLI status integration.
