...
const SIDEBAR_WIDTH_STORAGE_KEY = "pide.sidebar.width";
const SIDEBAR_VIEW_STORAGE_KEY = "pide.sidebar.view";
const SIDEBAR_COLLAPSED_STORAGE_KEY = "pide.sidebar.collapsed";
