  ...
  return (
    <div className="flex h-full min-h-0 flex-col bg-background">
      ...
      >
        ...
        >
          ...
          >
            ...
            <div
              ...
              className="h-[calc(100%-1.75rem)] min-h-0 overflow-y-auto"
            >
              <div
        ...
        <ResizablePanel id="history-content" defaultSize="76%" minSize="45%">
            ...
            <ResizablePanelGroup orientation="vertical">
              ...
              >
                <section
                  ...
                  className="h-full min-w-0 overflow-x-hidden overflow-y-auto px-4 py-3"
                >
                  ...
                  <div className="mt-2 flex items-center gap-1">
                    ...
                    {webUrl && remoteWeb ? (
                      <Button
                        ...
                        className="h-6 cursor-pointer gap-1.5 px-1.5 text-[11px] text-muted-foreground hover:text-foreground"
                        onClick={() =>
                          void openUrl(webUrl).catch(console.error)
                        }
                      >
                        <HugeiconsIcon
                        ...
                        <div className="flex h-full min-h-0 flex-col gap-2">
                          <div className="flex shrink-0 items-center justify-end">
                            <Button
                              ...
                              onClick={() =>
                                onOpenFileTab(commit, selectedFile)
                              }
                            >
                              Open in tab
                            </Button>
